...
const createNew = async (reqBody) => {
  try {
    ...
    const customSubject = 'PA MATERIAL: Xác thực tài khoản của bạn'
    ...
    const htmlContent = `
        ...
        <div style="padding: 50px 30px; background-color: #ffffff; text-align: center;">
          <h2 style="color: #2563eb; margin-top: 0; font-family: 'Georgia', serif; font-weight: normal; font-size: 22px; letter-spacing: 1px;">
            Chào mừng bạn đến với PA Material!
          </h2>
          <p style="font-size: 15px; color: #555555; margin-bottom: 25px;">Kính chào <strong>${userName}</strong>,</p>
          <p style="font-size: 15px; color: #555555;">
            Cảm ơn bạn đã đồng hành cùng <strong>PA Material</strong>. Để bắt đầu trải nghiệm mua sắm vật liệu xây dựng chất lượng và tận hưởng các ưu đãi thành viên, vui lòng xác thực email của bạn.
          </p>
          <div style="margin: 40px 0;">
            <a href="${verificationLink}" target="_blank" style="background-color: #2563eb; color: #ffffff; padding: 14px 36px; text-decoration: none; border: 1px solid #2563eb; font-weight: 500; font-size: 13px; text-transform: uppercase; letter-spacing: 2px; display: inline-block; border-radius: 4px;">
              Hoàn Tất Xác Thực
            </a>
          </div>
        ...
        <div style="background-color: #fafafa; padding: 30px 20px; text-align: center; font-size: 11px; color: #999999; letter-spacing: 0.5px;">
          ...
          <p style="margin: 5px 0;">&copy; 2026 PA Material.</p>
        </div>
      </div>
      `
...
const forgotPassword = async (reqBody) => {
  try {
    ...
    if (existUser) {
      ...
      const customSubject = 'PA Material: Khôi phục mật khẩu'
      ...
      const htmlContent = `
        <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; line-height: 1.8; color: #333333; max-width: 600px; margin: 0 auto; border: 1px solid #eaeaea; overflow: hidden; background-color: #ffffff;">
          ...
          <div style="padding: 50px 30px; background-color: #ffffff; text-align: center;">
            ...
            <div style="margin: 40px 0;">
              <a href="${resetLink}" target="_blank" style="background-color: #2563eb; color: #ffffff; padding: 14px 36px; text-decoration: none; border: 1px solid #2563eb; font-weight: 500; font-size: 13px; text-transform: uppercase; letter-spacing: 2px; display: inline-block; border-radius: 4px;">
                Đặt Lại Mật Khẩu
              </a>
            </div>
