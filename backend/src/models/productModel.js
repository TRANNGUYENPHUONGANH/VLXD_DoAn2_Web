...
const PRODUCT_COLLECTION_SCHEMA = Joi.object({
  ...
  unit: Joi.string().trim().default(null),
  origin: Joi.string().trim().default(null),
  brand: Joi.string().trim().default(null),
  specifications: Joi.string().trim().default(null),
  warranty: Joi.string().trim().default(null),
